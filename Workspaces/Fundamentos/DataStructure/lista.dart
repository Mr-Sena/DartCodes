...
void main() {
  ...
  //Agora com spread não; inclusive da pra adicionar uma lógica como uma regra na própria inclusão. Veja: 
  ...
  //A verificação garante que não tera exceções, mesmo se a lista estiver vazia - que é o que acontece 
